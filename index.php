            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <p class="lead">Este aplicativo WEB foi construido utilizando HTML5, JavaScript e o Framework Bootstrap, faz parte de exercício proposto aos alunos para exercítar as habilidades de construção de paginas e aplicativos.</p>
                        <p><a class="btn btn-primary" href="https://github.com/GamerzinBR259/novacalculadora">Código desta Calculadora no Github</a></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h2>Quem Sou?</h2>
                        <p class="lead">Sou aluno de informática Victor Baccon</p>
                        <div >
                            <h2 class="mb-4">Dá um Fork nos meus repositórios</h2>
                            <a class="btn btn-xl btn-dark" href="https://github.com/GamerzinBR259"> GamerzinBR259</a>
                        </div>
                    </div>
                </div>
            </div>
